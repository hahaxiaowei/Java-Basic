...
public class ShallowCopyTest extends TestCase {
    ...
    public void testShallowCopy()throws Exception{
        ...
        PersonShallowCopy shallowCopy2 =(PersonShallowCopy)shallowCopy1.clone();

//        System.out.printf(shallowCopy1.name+"\r\n");
//        System.out.printf(shallowCopy2.name+"\r\n");

        System.out.printf(shallowCopy1.date+"\r\n");
        System.out.printf(shallowCopy2.date+"\r\n");

//        shallowCopy1.name = "xiaoming";
